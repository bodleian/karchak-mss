...
declare variable $base := doc("../authority/works.xml")/tei:TEI/tei:text/tei:body/tei:listBibl/tei:bibl[@xml:id];
            ...
            <listBibl>
{
    ...
    return (
        ...
        $linebreak,
        $linebreak,
        comment{' TODO: Review the following entries, update their key attributes in the TEI files, then cut and paste them into works.xml '},
        $linebreak,
